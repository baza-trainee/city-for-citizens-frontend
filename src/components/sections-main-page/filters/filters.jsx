...
export function Filters() {
  ...
  return (
    <section className="relative z-10 mt-20 flex flex-col items-center justify-center bg-light-primary dark:bg-dark-primary tablet:mt-40">
      ...
      <div className="mb-8 mt-6 flex w-full flex-col flex-wrap gap-4 px-4 laptop:px-10 desktop:flex-row desktop:flex-nowrap desktop_l:mx-auto desktop_l:w-fit">
        <div className="relative z-10 flex grow flex-col gap-4 tablet:flex-row">
          <div className="relative z-10 tablet:w-[calc(50%-8px)] desktop:w-[calc((100vw-112px)/3)] desktop:max-w-[469px] desktop_l:w-[469px]">
            <ChooseCity filtersEventCities={data?.eventCities || []} />
          </div>
          <div className="relative z-0 tablet:w-[calc(50%-8px)] desktop:w-[calc((100vw-112px)/3)]  desktop:max-w-[469px] desktop_l:w-[469px]">
            <DatePicker filtersEventDates={data?.eventDates || []} />
          </div>
        </div>
        <div className="relative z-0 grow  desktop:w-[calc((100vw-112px)/3)]  desktop:max-w-[469px] desktop_l:w-[469px] ">
