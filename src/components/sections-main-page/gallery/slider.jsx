    ...
    >
      ...
      {data?.map((item, index) => (
        <SwiperSlide
          ...
          className="gallery-swiper group relative overflow-hidden rounded-lg"
        >
          <Image
            src={item.url}
            alt={item.title}
          ...
          ></Image>
          <div className="absolute bottom-0 left-0 flex w-full flex-col justify-center gap-2 rounded-lg bg-light-secondary p-4 text-start opacity-0 shadow-gallery transition-opacity duration-500 ease-in-out focus:opacity-100 group-hover:opacity-100 dark:bg-dark-secondary">
