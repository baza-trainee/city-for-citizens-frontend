...
import IconCloseButton from '@/components-old/UI/icons/IconClose';
...
const EventList = () => {
  ...
  return (
    <div>
        ...
        <div className="flex">
          <div className="relative">
            ...
            <input
              ...
              } border-gray/20 rounded-full border p-2 pl-[35px] transition duration-200 focus:outline-none`}
            />
          </div>
          <Link
            className="hover:bg-primary/100 group block self-center rounded-lg bg-[#6589e3] py-1 text-center transition duration-200 hover:text-[#ffffff]"
            href={'/admin/event'}
          >
      ...
      <div className="border-gray/10 grid grid-cols-1 grid-rows-[auto_auto] gap-y-3 rounded-lg border px-4 pb-4">
        <div
          className={`border-gray/10 grid grid-cols-[10px_4fr_2fr_2fr_1fr] content-center  
          items-center justify-items-center gap-x-3 border-b-[1px] p-3`}
        >
          ...
          <button
            className={`group rounded-lg  px-[9px] text-sm ${
              isMobile
                ? null
                : resolvedTheme === 'dark'
                  ? ' text-gray/5 disabled:bg-gray/100 disabled:text-gray/50 disabled:hover:bg-gray/100 bg-[#d43c3c] hover:bg-[red]'
                  : ' text-gray/100 disabled:bg-gray/5 disabled:text-gray/20 disabled:hover:bg-gray/5 bg-[#d43c3c] hover:bg-[red]'
            }`}
